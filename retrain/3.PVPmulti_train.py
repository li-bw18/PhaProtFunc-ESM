...
optimizer = torch.optim.Adam(pvpmulti.parameters(), lr=learning_rate, weight_decay=weight_decay)
train_loss_list, valid_loss_list, valid_acc_list = trail(pvpmulti, train_dataloader, val_dataloader, criterion, optimizer, nepoch, "model/PVPmulti.pth")
